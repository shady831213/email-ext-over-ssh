package org.jenkinsci.plugins.emailextoverssh.watching;
...
public class EmailExtWatchAction implements Action {
    ...
    public String getDisplayName() {
        if(isWatching()) {
            return org.jenkinsci.plugins.emailextoverssh.Messages.EmailExtWatchAction_DisplayNameWatching();
        } else {
            return org.jenkinsci.plugins.emailextoverssh.Messages.EmailExtWatchAction_DisplayName();
        }
    }
