...
def triggers = org.jenkinsci.plugins.emailextoverssh.plugins.EmailTrigger.all()
...
f.advanced(title: _("Advanced Settings")) {
  ...
  if(instance != null) {
    ...
    jenkins.model.Jenkins.instance.getDescriptor(org.jenkinsci.plugins.emailextoverssh.ExtendedEmailPublisher).defaultTriggerIds.each { t ->
