...
def descriptor = app.getDescriptor("org.jenkinsci.plugins.emailextoverssh.ExtendedEmailPublisher")
        ...
        if(hasPermission) {
            ...
            if(mailerProperty==null) {
                ...
                f.form(method: "post", action: "configSubmit", name: "config") {
                    ...
                    def triggers = org.jenkinsci.plugins.emailextoverssh.plugins.EmailTrigger.all().findAll { t -> t.isWatchable() }
